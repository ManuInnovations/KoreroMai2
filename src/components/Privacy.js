  ...
  render() {
    ...
    return (
      <div className='privacy-policy'>
          ...
          put in place suitable physical, electronic and managerial procedures to safeguard and secure any personal information collected.</p>
          ...
          <p className='article'>It is our policy to send only emails
          you elect to receive in a sign-up process. In addition, we may
          send out promotional material to you promoting new or amended material on our site where we
          ...
          <p className='article'>You have the right to seek access the personal information held about you and to advise us of any
          inaccuracy. There are some exceptions to this right set out in the Privacy Act. If you make an
